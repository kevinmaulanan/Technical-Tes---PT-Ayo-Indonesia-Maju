        ...
        <div class="col-8">
            ...
            <form method="post" action="{{url('/admin/team')}} " enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('team_name') is-invalid @enderror" id="team_name" placeholder="Masukkan nama tim" name="team_name">
                ...
                <div class="form-group">
                    ...
                    <div class='input-group date' id='datetimepicker5'>
                        <input class="form-control @error('date') is-invalid @enderror" type="date" value="2020-5-29"name="date">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('address') is-invalid @enderror" name="address"  placeholder="Masukkan alamat markas tim"></textarea>
                    @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('city') is-invalid @enderror" id="city" placeholder="Masukkan kota tim" name="city">
